...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
    ...
    <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
        <LastAuthor>那些年不想说的事</LastAuthor>
        <Created>2006-09-16T00:00:00Z</Created>
        <LastSaved>2018-08-08T05:39:58Z</LastSaved>
    </DocumentProperties>
    <CustomDocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
        <KSOProductBuildVer dt:dt="string">2052-10.1.0.7469
        </KSOProductBuildVer>
    ...
    <Styles>
        <Style ss:ID="s26" ss:Name="检查单元格">
            <Borders>
                ...
                <Border ss:Position="Right" ss:LineStyle="Double"
                    ss:Weight="3" ss:Color="#3F3F3F" />
                <Border ss:Position="Top" ss:LineStyle="Double"
                    ss:Weight="3" ss:Color="#3F3F3F" />
            </Borders>
        ...
        <Style ss:ID="s63" ss:Parent="s49">
            <Font ss:FontName="宋体" x:CharSet="134" ss:Size="9" />
            <Interior />
        </Style>
        <Style ss:ID="s64" ss:Parent="s49">
            <Font ss:FontName="宋体" x:CharSet="134" ss:Size="9" />
            <Interior />
            <NumberFormat ss:Format="0.00_);[Red]\(0.00\)" />
        </Style>
        <Style ss:ID="s65" ss:Parent="s49">
            <Font ss:FontName="宋体" x:CharSet="134" ss:Size="9" />
            <Interior />
            <NumberFormat ss:Format="0.0_);[Red]\(0.0\)" />
        </Style>
        <Style ss:ID="s66" ss:Parent="s50" />
        <Style ss:ID="s67" ss:Parent="s50">
            <NumberFormat ss:Format="0.0_);[Red]\(0.0\)" />
        </Style>
        <Style ss:ID="s68" ss:Parent="s49">
            <Interior />
        </Style>
        <Style ss:ID="s69" ss:Parent="s49">
            <Alignment ss:Horizontal="Center" ss:WrapText="1" />
            <Interior />
            <NumberFormat />
        </Style>
        <Style ss:ID="s70" ss:Parent="s49">
            <Alignment ss:WrapText="1" />
            <Borders>
                <Border ss:Position="Bottom" ss:LineStyle="Continuous"
                    ss:Weight="1" />
        ...
        <Style ss:ID="s72" ss:Parent="s49">
            <Alignment ss:Horizontal="Center" />
            <Font ss:FontName="宋体" x:CharSet="134" ss:Size="9" />
            <Interior />
        </Style>
        <Style ss:ID="s73" ss:Parent="s49">
            <Font ss:FontName="宋体" x:CharSet="134" ss:Size="12"
                ss:Color="#FF0000" />
            <Interior />
        </Style>
        <Style ss:ID="s74" ss:Parent="s49">
            <Alignment />
            <Font ss:FontName="宋体" x:CharSet="134" ss:Size="9" />
            <Interior />
            <NumberFormat ss:Format="0.00_);[Red]\(0.00\)" />
        </Style>
        <Style ss:ID="s75" ss:Parent="s49">
            <Font ss:FontName="宋体" x:CharSet="134" ss:Size="9" />
            <Interior />
            <NumberFormat ss:Format="0.00_ " />
        </Style>
        <Style ss:ID="s76" ss:Parent="s49">
            <Alignment ss:Horizontal="Center" />
            <Borders>
                <Border ss:Position="Bottom" ss:LineStyle="Continuous"
                    ss:Weight="1" />
    ...
    <Worksheet ss:Name="Sheet1">
        <Table ss:ExpandedColumnCount="14" ss:ExpandedRowCount="235"
            x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54"
            ss:DefaultRowHeight="13.5">
            <Column ss:Index="1" ss:StyleID="Default"
                ss:AutoFitWidth="0" ss:Width="28.5" />
            <Column ss:Index="2" ss:StyleID="Default"
                ss:AutoFitWidth="0" ss:Width="36" />
            <Column ss:Index="4" ss:StyleID="Default"
                ss:AutoFitWidth="0" ss:Width="89.25" />
            <Column ss:StyleID="s52" ss:AutoFitWidth="0"
                ss:Width="74.25" />
            <Column ss:StyleID="Default" ss:AutoFitWidth="0"
                ss:Width="57.75" ss:Span="2" />
            <Column ss:Index="9" ss:StyleID="Default"
                ss:AutoFitWidth="0" ss:Width="74.25" />
            <Column ss:StyleID="Default" ss:AutoFitWidth="0"
                ss:Width="57.75" />
            <Column ss:StyleID="Default" ss:AutoFitWidth="0"
                ss:Width="456" />
            ...
            <Column ss:StyleID="Default" ss:AutoFitWidth="0"
                ss:Width="78.75" />
            <Row ss:Height="14.25">
                <Cell ss:StyleID="s76" ss:MergeAcross="12">
                    <Data ss:Type="String">${date}加班、请假统计表</Data>
                </Cell>
            </Row>
            <Row ss:Height="14.25">
                <Cell ss:StyleID="s54">
                ...
                <Cell ss:StyleID="s54">
                    <Data ss:Type="String">奖金</Data>
                </Cell>
                <Cell ss:StyleID="s56">
                    <Data ss:Type="String"> 加班（小时）</Data>
                </Cell>
                <Cell ss:StyleID="s54">
                    <Data ss:Type="String">病假（天）</Data>
                </Cell>
                <Cell ss:StyleID="s54">
                    <Data ss:Type="String">事假（天）</Data>
                </Cell>
                <Cell ss:StyleID="s54">
                    <Data ss:Type="String">年假（天）</Data>
                </Cell>
                <Cell ss:StyleID="s54">
                    <Data ss:Type="String"> 产检假（天）</Data>
                </Cell>
                <Cell ss:StyleID="s54">
                    <Data ss:Type="String">婚假（天）</Data>
                </Cell>
                <Cell ss:StyleID="s54">
                    <Data ss:Type="String">加班明细</Data>
                </Cell>
                <Cell ss:StyleID="s55">
                    <Data ss:Type="String">餐补次数</Data>
                </Cell>
                <Cell ss:StyleID="s55">
                    <Data ss:Type="String">餐补金额（元）</Data>
                </Cell>
            </Row>
            <#if userList?? >
            <#list userList as user>
            <#if user_index==0>
            <Row ss:Height="${user.workdetails?size*13.5}">
                <Cell ss:StyleID="s57" ss:Formula="=ROW()-2">
                    <Data ss:Type="Number"></Data>
                </Cell>
                <Cell ss:StyleID="s58">
                    <Data ss:Type="String">${user.realname}</Data>
                </Cell>
                <Cell ss:StyleID="s77" ss:MergeDown="${userList?size-1}">
                    <Data ss:Type="String">${user.department}</Data>
                </Cell>
                <Cell ss:StyleID="s60">
                    <Data ss:Type="Number">${user.bonus}</Data>
                </Cell>
                <Cell ss:StyleID="s61">
                    <Data ss:Type="Number">${user.hours}</Data>
                </Cell>
                <Cell ss:StyleID="s61">
                    <Data ss:Type="Number">${user.leave1}</Data>
                </Cell>
                <Cell ss:StyleID="s62">
                    <Data ss:Type="Number">${user.leave2}</Data>
                </Cell>
                <Cell ss:StyleID="s62">
                    <Data ss:Type="Number">${user.leave3}</Data>
                </Cell>
                <Cell ss:StyleID="s62">
                    <Data ss:Type="Number">${user.leave4}</Data>
                </Cell>
                <Cell ss:StyleID="s62">
                    <Data ss:Type="Number">${user.leave5}</Data>
                </Cell>
                <Cell ss:StyleID="s58">
                    <Data ss:Type="String"><#list user.workdetails as item><#if item_index!=0>&#10;</#if>${item}</#list></Data>
                </Cell>
                <Cell ss:StyleID="s60">
                    <Data ss:Type="Number">${user.meals}</Data>
                </Cell>
                <Cell ss:StyleID="s60">
                    <Data ss:Type="Number">${user.mealsmoney}</Data>
                </Cell>
            </Row>
            <#else>
            <Row ss:Height="${user.workdetails?size*13.5}">
                ...
                <Cell ss:StyleID="s60" ss:Index="4">
                    <Data ss:Type="Number">${user.bonus}</Data>
                </Cell>
                <Cell ss:StyleID="s61">
                    <Data ss:Type="Number">${user.hours}</Data>
            ...
            <Row ss:Height="13.5"></Row>
        </Table>
        <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
            <PageSetup>
                <Header x:Margin="0.3" />
                <Footer x:Margin="0.3" />
                <PageMargins x:Left="0.699305555555556"
                    x:Right="0.699305555555556" x:Top="0.75" x:Bottom="0.75" />
            </PageSetup>
            <Selected />
            ...
            <Panes>
                <Pane>
                    ...
                    <RangeSelection>R3:R13</RangeSelection>
                </Pane>
            </Panes>
